...
namespace DriveShare.API.Services.Interfaces
{
    ...
    {
        Task<ApiResponse<PaginatedResult<CarPost>>> GetAllApprovedCarsAsync(string? brand = null, string? location = null, decimal? minPrice = null, decimal? maxPrice = null, string? sortOrder = null, int page = 1, int pageSize = 10);
